package thedefierwagdtd.character;
...
import thedefierwagdtd.cards.basic.Defend;
import thedefierwagdtd.cards.basic.Surge;
import thedefierwagdtd.cards.basic.PlayfulTwitch;
import thedefierwagdtd.cards.basic.Strike;
import thedefierwagdtd.relics.TheLastWish;

import java.util.ArrayList;

import static thedefierwagdtd.TheDefierModWAGDTD.*;

public class TheDefier extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheDefier"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THE_DEFIER;
        ...
        private static final Color cardColor = new Color(175f/255f, 87f/255f, 0f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheDefier(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public TheDefier() {
        super(getNames()[0], Meta.THE_DEFIER,
        ...
        initializeClass(characterPath("maincharacter.png"),
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
