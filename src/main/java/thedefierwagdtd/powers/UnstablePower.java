...
public class UnstablePower extends BasePower {
    public static final String POWER_ID = makeID(UnstablePower.class.getSimpleName());
    ...
    public void onEnergyRecharge() {
        ...
        addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)owner, (AbstractCreature)owner,
                (AbstractPower)new VulnerablePower((AbstractCreature)owner, this.amount, false), this.amount));
