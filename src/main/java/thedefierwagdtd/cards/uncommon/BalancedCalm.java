...
public class BalancedCalm extends BaseCard {
    public static final String ID = makeID(BalancedCalm.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p,
                (AbstractPower)new BalancedCalmPower((AbstractCreature)p, this.magicNumber),
                this.magicNumber));
    }
}
