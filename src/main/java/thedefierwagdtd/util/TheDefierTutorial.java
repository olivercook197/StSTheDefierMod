...
//Taken from Downfall
public class TheDefierTutorial extends FtueTip {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("thedefierwagdtd:TheDefierTutorial");

    public static final String[] txt = uiStrings.TEXT;

    public static final String[] LABEL = uiStrings.EXTRA_TEXT;
    ...
    public TheDefierTutorial() {
        this.img1 = TextureLoader.getTexture("thedefierwagdtd/images/tip/TheDefierTip1.png");
        this.img2 = TextureLoader.getTexture("thedefierwagdtd/images/tip/TheDefierTip2.png");
        txt1 = txt[0];
        txt2 = txt[1];
        this.closeScreen = -1;
